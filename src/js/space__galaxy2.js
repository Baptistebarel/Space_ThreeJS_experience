...
export default  class SpaceGalaxy2 
{
    constructor(_option)
    {
        this.textureLoader = _option.textureLoader
        this.galaxyChoice2 = _option.galaxyChoice2
        ...
        this.galaxyChoice2Planet4 = _option.galaxyChoice1Planet2
    ...
    setStars()
    {
        ...
        this.stars.points.position.z =  -400
    ...
    setPlanet1()
    {
        ...
        this.planete1.mesh.position.z =  -440
    ...
    setPlanet2()
    {
        ...
        this.planete2.material = new THREE.MeshBasicMaterial({
            map:  this.galaxyChoice2Planet4
        })
        this.planete2.mesh = new THREE.Mesh(this.planete2.geometry, this.planete2.material)
        this.planete2.mesh.position.z =  -350
        this.planete2.mesh.position.x =  -40
        this.planete2.mesh.position.y =  -50
    ...
    setPlanet3()
    {
        ...
        this.planete3.mesh.position.z =  -310
        this.planete3.mesh.position.x =  -30
        this.planete3.mesh.position.y =  35
    ...
    {
        this.planete3 = {}
        this.planete3.geometry = new THREE.SphereGeometry(30, 45, 45 )
        this.planete3.material = new THREE.MeshBasicMaterial({
            map:  this.galaxyChoice2Planet3
        })
        this.planete3.mesh = new THREE.Mesh(this.planete3.geometry, this.planete3.material)
        this.planete3.mesh.position.z =  -440
        this.planete3.mesh.position.x =  50
        this.planete3.mesh.position.y =  -45
        this.planete3.mesh.rotation.z =  -0.5
        this.container.add(this.planete3.mesh)
    }
